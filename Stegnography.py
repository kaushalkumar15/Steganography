...
def main():
    ...
    a = int(input(":: Welcome to Steganography ::\n"
                            "1. Encode\n2. Decode\nEnter the above choice then press 'Enter' key:\n"))
                            
    if (a == 1):
       img1 = input("Enter the image to hide (With file extension):")
       img2 = input("Enter the image to be hidden (With file extension):")
       output = input("Enter the name of the new image created (With file extension png):")
       merged_image = Steganography.merge(Image.open(img1), Image.open(img2))
       merged_image.save(output)
       print("Image encoded successfully...!!!")
    
    elif (a == 2):
        img = input("Enter image to be decoded (With file extension):")
        output = input("Enter the name of the decoded image :")
